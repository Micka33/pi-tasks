...
const TaskNotes = Type.Optional(Type.Union([Type.String(), Type.Null()], {
...
const TaskUpdateAssignedToAgentId = Type.Optional(Type.Union([Type.String(), Type.Null()], {
...
export const TaskListsFindParams = Type.Object({
    ...
    include_inaccessible_private: Type.Optional(Type.Boolean({ description: "Requires explicit user confirmation before private lists owned by others are returned." })),
});
